...
TEST_F(GGUFHeaderTest, ValidHeader) {
    ...
    EXPECT_TRUE(result.error().find("partially implemented") != std::string::npos ||
...
RC_GTEST_PROP(CorruptedFileProperty, RandomBytesReturnError,
...
RC_GTEST_PROP(CorruptedFileProperty, TruncatedFilesReturnError,
              (int truncate_at)) {
...
RC_GTEST_PROP(CorruptedFileProperty, WrongVersionReturnError,
